                                ...
                                <tbody>
                                    @foreach ($comments as $comment)
                                        <tr class="even pointer">
                                            ...
                                            <td class="">{{ $comment->comment_weight }}</td>
                                            <td class=" last">
                                                <a data-toggle="modal" data-target="#editComment-{{ $comment->id }}"
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <form method="POST" name="site_form" role="form"
                                                            action="{{ route('settings.updateComment', ['id' => $comment->id]) }}">
                                                            @csrf
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" name="comment_weight"
                                                                    class="form-control"
                                                                    value="{{ $comment->comment_weight }}" required>
                                                            </div>
                                        ...
                                        <div class="modal fade" id="deleteComment-{{ $comment->id }}" tabindex="-1" role="dialog"
                                            ...
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <form method="GET" name="site_form" role="form" action="{{ route('settings.deleteComment', ['id'=>$comment->id]) }}">
                                                            <div class="form-group">
                        ...
                        <div class="modal fade" id="addComment" tabindex="-1" role="dialog"
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form method="POST" name="site_form" role="form"
                                            action="{{ route('settings.addComment') }}">
                                            @csrf
                                            <div class="form-group">
